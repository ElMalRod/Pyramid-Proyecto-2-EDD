...
public class ServicioUsuario {
   ...
   int nivel = 0;
    ...
    public ResponseEntity<HashMap<Integer, String>> getLevel(@RequestParam String level) {

        int a = Integer.valueOf(level);
        return new ResponseEntity<HashMap<Integer, String>>(opNiveles.recibirNivel(a, tree), HttpStatus.OK);
    }

    // avltree?transversal=postOrder
    @RequestMapping(value = "/avltree", method = RequestMethod.GET)
    public ResponseEntity<HashMap<Integer, String>> mandarOrden(@RequestParam String transversal) {

        //return opNiveles.recibirOrden(orden, tree);
        return new ResponseEntity<HashMap<Integer, String>>(opNiveles.recibirOrden(transversal, tree), HttpStatus.OK);
    }
